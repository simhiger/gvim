...
"hi vsifString       	ctermfg=lightBlue guibg=lightcyan guifg=black
"hi vsifComment     	ctermbg=White ctermfg=Blue gui=reverse guibg=DarkBlue guifg=LightGray
"hi vsifComment     	ctermfg=Blue guifg=Blue
"hi vsifComment     	term=reverse ctermbg=Yellow ctermfg=Black guibg=Yellow guifg=Black
"hi link vsifConstant        Constant
"hi vsifNumber       	ctermfg=black gui=bold guifg=black
